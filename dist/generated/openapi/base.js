...
var BASE_PATH = "http://localhost/codingtest".replace(/\/+$/, "");
...
var BaseAPI = function BaseAPI(configuration) {
    "use strict";
    var basePath = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : BASE_PATH, axios = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : _axios.default;
