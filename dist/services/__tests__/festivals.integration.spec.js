...
var _printerService = require("../printer.service");
...
describe("Integration", function() {
    ...
    beforeEach(function() {
        ...
        var festivalsService = new _festivalsService.FestivalsService(festivalsApi, logger);
        printerService = new _printerService.PrinterService(festivalsService, logger);
    });
    it("should print out festival data", /*#__PURE__*/ _asyncToGenerator(function() {
        var festivals;
